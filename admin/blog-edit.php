...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($content)) {
        ...
        if (empty($error)) {
            ...
            if ($blog->updatePost($postId, $updateData)) {
...
<head>
    ...
    <title>Modifier l'article - MBC Expert Comptable</title>
                ...
                <div class="card-content">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3" placeholder="Résumé court de l'article..."><?php echo htmlspecialchars($post['excerpt']); ?></textarea>
                            <div class="help-text">Si non renseigné, un extrait sera généré automatiquement</div>
                        </div>

                        <div class="form-group">
                            <label for="content">Contenu de l'article *</label>
                            <textarea id="content" name="content" rows="15" required placeholder="Rédigez votre article ici..."><?php echo htmlspecialchars($post['content']); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($post['cover_image']): ?>
                                    <div class="current-file">
                                        <strong>Image actuelle :</strong> <?php echo htmlspecialchars($post['cover_image']); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload">
                                    ...
                                    <label for="content_file" class="file-upload-label">
                                        <i class="fas fa-file"></i> Choisir un nouveau fichier
                                    </label>
                                    <div class="help-text">PDF, DOC, DOCX, TXT (max 10MB)</div>
                                </div>
                                <?php if ($post['content_file']): ?>
                                    <div class="current-file">
                                        <strong>Fichier actuel :</strong> <?php echo htmlspecialchars($post['content_file']); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
